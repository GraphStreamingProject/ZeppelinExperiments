...
struct Bucket_Boruvka {
   ...
   */
  inline static XXH64_hash_t gen_bucket_seed(const unsigned bucket_id,
                                             long seed) {
   ...
   */
  inline static ubucket_t gen_r(const XXH64_hash_t& bucket_seed,
   ...
   */
  bool contains(const vec_t& index, const XXH64_hash_t& bucket_seed,
   ...
   */
  bool is_good(const vec_t& n, const ubucket_t& large_prime,
               const XXH64_hash_t& bucket_seed, const ubucket_t& r,
               const vec_t& guess_nonzero) const;
   ...
   * @param r This Bucket's r, generated with gen_r.
   */
  void update(const Update& update, const ubucket_t& large_prime,
              const ubucket_t& r);
   ...
   */
  void cached_update(const Update& update, const ubucket_t& large_prime,
