...
# /path/to/run_unlim_speed_expr.sh use_guttertree[yes/no] input_files[input_files+]
...
do
	...
	./speed_process_stream $input $result_dir/test_`basename $input`/runtime_stats $use_guttertree &
	pid=$!
